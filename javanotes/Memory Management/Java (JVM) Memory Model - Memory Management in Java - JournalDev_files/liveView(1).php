...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=104397&cbuster=380334305&pubUrl=https://www.journaldev.com/2856/java-jvm-memory-model-memory-management-in-java&subId=[SUBID_ENCODED]&x=300&y=235&schain=1.0,1!newormedia.com,2273,1&cbuster=1609186106',
					origQString: 's=104397&cbuster=380334305&pubUrl=https://www.journaldev.com/2856/java-jvm-memory-model-memory-management-in-java&subId=[SUBID_ENCODED]&x=300&y=235&schain=1.0,1!newormedia.com,2273,1',
					placementId: 104397,
					x: 300,
					y: 235,
					videoType: 'flow',
